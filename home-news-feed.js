...
$(function () {
		...
		$.ajax({
		    ...
		    crossDomain: "true",
		    dataType: "jsonp",
		    url: "https://www.serveit.club/okng/json/home-news",
		    headers: {
		    		// No headers
				}
		}).done(function(data) {
			...
			$.each(json_obj, function (index,item) {
					...
					if (newsImage != null) {
						...
						if (newsImageCheck == true) {
						    var outputImage = "<a class='scale-hover overlay-hover-2x' href='" + newsURL + "'><div class='news-image home-image'><img src='" + newsImage + "' alt='" + newsTitle + "' /></a></div>";
							} else if (YTThumb != "") {
						    outputImage = "<a class='scale-hover overlay-hover-2x' href='" + YTURL + "' data-lity><div class='youtube-image home-image'><img src='" + YTThumb + "' alt='" + newsTitle + "' /></a></div>";
					...
					if (index < 3) {
						...
						//HEADER ITEMS//
						$( "<div class='col-md-4 col-sm-6'>" ) // add News Story DIV
						.append("<div class='gfort-block image-block gfort-block-style-1 wow fadeIn top-news-story' data-wow-duration='1.5s' data-wow-delay='0.75s'><div class='gfort-block-container'><div class='gfort-block-head'>" + outputImage + "</div><div class='gfort-block-body'><div class='gfort-block-title'><h4>" + outputLink + newsTitle + "</h4></a></div><div class='gfort-block-content'><p>" + outputByline + outputSummary.substring(0,200) + "...</p></div></div></div></div></div>")
						.appendTo( ".news-header" ); // insert into the Feed DIV
